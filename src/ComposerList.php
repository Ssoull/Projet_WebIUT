...
echo "\t\t\t\t<div class='grid_3'>\n";
                    ...
                    echo "\t\t\t\t\t\t\t<p>\n\t\t\t\t\t\t\t\t<img width='100%' height='100%' alt='Image du Compositeur : " . $Nom_Musicien . "' src='DataBaseImageAccess.php?Code=" . $Code_Musicien . "'/>\n\t\t\t\t\t\t\t</p>\n";
                    echo "\t\t\t\t\t\t</div>\n";
                    echo "\t\t\t\t\t\t<div class='box2'>\n";
                    echo "\t\t\t\t\t\t\t<a href='#' class='btn'>Album</a>\n";
                    echo "\t\t\t\t\t\t</div>\n";
                    echo "\t\t\t\t\t</div>\n";
                    echo "\t\t\t\t</div>\n";
